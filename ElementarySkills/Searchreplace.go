...
// Instructions
// Write a program that takes 3 arguments, the first argument 
// is a string in which a letter (the 2nd argument) will be replaced by
// another one (the 3rd argument).
